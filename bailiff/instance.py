...
def extract_instance_information(instance):
    ...
    information['LaunchDate'] = instance['LaunchTime']
...
def classify_instance(instance_information):
    ...
    if instance_information['Stopped'] and datetime.datetime.now() - instance_information['LastActionDate'] > datetime.timedelta(15):
        return 'SLEEPY'
